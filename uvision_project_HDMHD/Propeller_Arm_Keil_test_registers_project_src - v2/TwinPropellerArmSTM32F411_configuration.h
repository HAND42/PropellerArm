...
#define USART6_IRQ_PRIORITY  6// QT INTERFACE COMMUNICATION
#define I2C3_IRQ_PRIORITY    7// I2C SLAVE STM32 MASTER ARDUINO SCREEN		  
#define IT_TIM2_IRQ_PRIORITY 8// TIMER INTERRUPTION FOR DEBOUNCING BUTTON HARDWARE OSCILLATION
...
#define Period_IT_Control_loop	0.1	//       		/* Control loop	*/
