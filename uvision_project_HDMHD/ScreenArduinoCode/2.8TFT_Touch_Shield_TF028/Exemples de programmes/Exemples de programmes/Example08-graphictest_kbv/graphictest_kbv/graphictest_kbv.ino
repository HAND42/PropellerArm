...
void setup(void) {
  ...
  if(g_identifier == 0x9325) {
    Serial.println(F("Found ILI9325 LCD driver"));
  } else if(g_identifier == 0x9328) {
    Serial.println(F("Found ILI9328 LCD driver"));
  } else if(g_identifier == 0x4535) {
    Serial.println(F("Found LGDP4535 LCD driver"));
  }else if(g_identifier == 0x7575) {
    Serial.println(F("Found HX8347G LCD driver"));
  } else if(g_identifier == 0x9341) {
    Serial.println(F("Found ILI9341 LCD driver"));
  }else if(g_identifier == 0x7783) {
    Serial.println(F("Found ST7781 LCD driver"));
  }else if(g_identifier == 0x8230) {
    Serial.println(F("Found UC8230 LCD driver"));
    g_identifier=0x7783;
  }
  else if(g_identifier == 0x8357) {
    Serial.println(F("Found HX8357D LCD driver"));
  } else if(g_identifier==0x0101)
  {     
      g_identifier=0x9341;
