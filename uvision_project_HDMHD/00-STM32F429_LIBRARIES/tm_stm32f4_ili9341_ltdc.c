...
void TM_ILI9341_InitPins(void) {
	...
	TM_GPIO_InitAlternate(GPIOA, GPIO_Pin_3 | GPIO_Pin_3 | GPIO_Pin_6 | GPIO_Pin_11 | GPIO_Pin_12, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High, GPIO_AF_LTDC);
