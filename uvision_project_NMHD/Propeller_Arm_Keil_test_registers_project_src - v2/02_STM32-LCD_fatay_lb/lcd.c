...
static void fallingEdge(void) {
	...
	static void send4Bits(char data) {
		HAL_GPIO_WritePin(GPIO_PORT, DATA4_Pin, SET_IF(data&0x01));
		HAL_GPIO_WritePin(GPIO_PORT, DATA5_Pin, SET_IF(data&0x02));
		HAL_GPIO_WritePin(GPIO_PORT, DATA6_Pin, SET_IF(data&0x04));
		HAL_GPIO_WritePin(GPIO_PORT, DATA7_Pin, SET_IF(data&0x08));
	...
	static void send8Bits(char val) {
		...
		HAL_GPIO_WritePin(GPIO_PORT, DATA0_Pin, SET_IF(val&0x01));
		HAL_GPIO_WritePin(GPIO_PORT, DATA1_Pin, SET_IF(val&0x02));
		HAL_GPIO_WritePin(GPIO_PORT, DATA2_Pin, SET_IF(val&0x04));
		HAL_GPIO_WritePin(GPIO_PORT, DATA3_Pin, SET_IF(val&0x08));
		HAL_GPIO_WritePin(GPIO_PORT, DATA4_Pin, SET_IF(val&0x10));
		HAL_GPIO_WritePin(GPIO_PORT, DATA5_Pin, SET_IF(val&0x20));
		HAL_GPIO_WritePin(GPIO_PORT, DATA6_Pin, SET_IF(val&0x40));
		HAL_GPIO_WritePin(GPIO_PORT, DATA7_Pin, SET_IF(val&0x80));
