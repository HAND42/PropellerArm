...
public:
    ...
    void setupUi(QMainWindow *view_formule)
    {
        if (view_formule->objectName().isEmpty())
            view_formule->setObjectName(QString::fromUtf8("view_formule"));
        ...
        titre_horizontalLayout->setObjectName(QString::fromUtf8("titre_horizontalLayout"));
        ...
        formule_horizontalLayout->setObjectName(QString::fromUtf8("formule_horizontalLayout"));
        formule_horizontalLayout->setSizeConstraint(QLayout::SetNoConstraint);
        formule_label = new QLabel(centralWidget);
        formule_label->setObjectName(QString::fromUtf8("formule_label"));
        ...
        formule_lineEdit->setObjectName(QString::fromUtf8("formule_lineEdit"));
        ...
        valider_horizontalLayout->setObjectName(QString::fromUtf8("valider_horizontalLayout"));
        ...
        verifier_la_formule_pushButton->setObjectName(QString::fromUtf8("verifier_la_formule_pushButton"));
        ...
        tester_la_formule_pushButton->setObjectName(QString::fromUtf8("tester_la_formule_pushButton"));
        ...
        formule_info_pushButton->setObjectName(QString::fromUtf8("formule_info_pushButton"));
        ...
        erreur_horizontalLayout->setObjectName(QString::fromUtf8("erreur_horizontalLayout"));
        erreur_horizontalLayout->setSizeConstraint(QLayout::SetNoConstraint);
        erreur_titre_label = new QLabel(centralWidget);
        erreur_titre_label->setObjectName(QString::fromUtf8("erreur_titre_label"));
    ...
    {
        view_formule->setWindowTitle(QApplication::translate("view_formule", "FORMULE", nullptr));
        titre_label->setText(QApplication::translate("view_formule", "FORMULE POUR CALCULER THRUST", nullptr));
        formule_label->setText(QApplication::translate("view_formule", "Formule:", nullptr));
        verifier_la_formule_pushButton->setText(QApplication::translate("view_formule", "VERIFIER LA FORMULE", nullptr));
        tester_la_formule_pushButton->setText(QApplication::translate("view_formule", "TESTER LA FORMULE", nullptr));
        formule_info_pushButton->setText(QApplication::translate("view_formule", "Informations", nullptr));
        erreur_titre_label->setText(QApplication::translate("view_formule", "ERREUR:", nullptr));
