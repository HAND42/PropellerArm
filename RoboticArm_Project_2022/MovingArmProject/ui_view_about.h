...
public:
    ...
    void setupUi(QDialog *view_about)
    {
        if (view_about->objectName().isEmpty())
            view_about->setObjectName(QString::fromUtf8("view_about"));
    ...
    {
        view_about->setWindowTitle(QApplication::translate("view_about", "About", nullptr));
        label->setText(QApplication::translate("view_about", "Fly Arm System\n"
"\n"
"\n"
