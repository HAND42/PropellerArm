...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(358, 91);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        ouvrir_view_formule_pushButton = new QPushButton(centralwidget);
        ouvrir_view_formule_pushButton->setObjectName(QString::fromUtf8("ouvrir_view_formule_pushButton"));
        ouvrir_view_formule_pushButton->setGeometry(QRect(80, 10, 181, 25));
        affichage_debuter_pushButton = new QPushButton(centralwidget);
        affichage_debuter_pushButton->setObjectName(QString::fromUtf8("affichage_debuter_pushButton"));
        ...
        affichage_finir_pushButton->setObjectName(QString::fromUtf8("affichage_finir_pushButton"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ouvrir_view_formule_pushButton->setText(QApplication::translate("MainWindow", "Entrer une formule", nullptr));
        affichage_debuter_pushButton->setText(QApplication::translate("MainWindow", "D\303\251buter l'affichage", nullptr));
        affichage_finir_pushButton->setText(QApplication::translate("MainWindow", "Finir l'affichage", nullptr));
