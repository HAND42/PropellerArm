...
public:
    ...
    void setupUi(QDialog *view_setting_PC_controller)
    {
        if (view_setting_PC_controller->objectName().isEmpty())
            view_setting_PC_controller->setObjectName(QString::fromUtf8("view_setting_PC_controller"));
        ...
        type_1_groupBox->setObjectName(QString::fromUtf8("type_1_groupBox"));
        type_1_groupBox->setGeometry(QRect(13, 42, 259, 100));
        cascade_controller_checkBox = new QCheckBox(type_1_groupBox);
        cascade_controller_checkBox->setObjectName(QString::fromUtf8("cascade_controller_checkBox"));
    ...
    {
        view_setting_PC_controller->setWindowTitle(QApplication::translate("view_setting_PC_controller", "PC control desired theta --> Configuration", nullptr));
        info_label->setText(QApplication::translate("view_setting_PC_controller", "Select your controller type and fill the arguments", nullptr));
        type_1_groupBox->setTitle(QApplication::translate("view_setting_PC_controller", "     Cascade Controller", nullptr));
        cascade_controller_checkBox->setText(QString());
        k1_label->setText(QApplication::translate("view_setting_PC_controller", "K1 : ", nullptr));
        k2_label->setText(QApplication::translate("view_setting_PC_controller", "K2 : ", nullptr));
        type_2_groupBox->setTitle(QApplication::translate("view_setting_PC_controller", "     Leadlag Controller", nullptr));
        leadlag_controller_checkBox->setText(QString());
        a1_label->setText(QApplication::translate("view_setting_PC_controller", "A1 : ", nullptr));
        a2_label->setText(QApplication::translate("view_setting_PC_controller", "A2 : ", nullptr));
        b1_label->setText(QApplication::translate("view_setting_PC_controller", "B1 : ", nullptr));
        b2_label->setText(QApplication::translate("view_setting_PC_controller", "B2 : ", nullptr));
        b3_label->setText(QApplication::translate("view_setting_PC_controller", "B3 : ", nullptr));
        apply_button->setText(QApplication::translate("view_setting_PC_controller", "Apply", nullptr));
        cancel_button->setText(QApplication::translate("view_setting_PC_controller", "Cancel", nullptr));
        reset_button->setText(QApplication::translate("view_setting_PC_controller", "Reset", nullptr));
    } // retranslateUi
