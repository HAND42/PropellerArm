...
int main (void)
{
	...
	/*  Debouncing check time to prevent expected button oscillation  */
		...
		PrintConsole(DEFAULT," Configuration of the Timer Interrupt Debouncing Oscillation of the ON/OFF Button ");
	...
	/* Implemented the usart6 in order to send QTdata and receive commands only for/by the QT interface */
		...
		PrintConsole(DEFAULT," Configuration of the QT Communication");
		Uart6Init();
	#endif   			 
